        ...
        ClaimManager.onClaimAdded(claim -> {
            ...
            for (MapPolygonWithHoles polygon : PolygonHelper.createChunksPolygon(claim.chunks(), 10)) {
                try {
                    ...
                    overlay.setOverlayGroupName("Claim Maps")
                    ...
                    ClaimMaps.LOGGER.error("Failed to create overlay for claim {} in world {}", claim.id(), claim.worldKey(), e);
                }
            }
