...
public class ClaimMaps implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        try {
            ...
            saveFolder = gameDir.resolve(MOD_ID);
            if (!Files.exists(saveFolder)) {
                LOGGER.info("Creating save folder for Claim Maps at {}", saveFolder);
            ...
            throw new RuntimeException("Failed to create save folder for Claim Maps", e);
        }
